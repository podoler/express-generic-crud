...
exports.update = function(req, res, next){
    ...
    crudService.update(req.getInstance(req.getCrud().getName()), req.getContext().getDetails(), function(err, resCrud){
...
exports.delete = function(req, res, next){
    ...
    crudService.delete(req.getInstance(req.getCrud().getName()), function(err, resCrud){
...
exports.create = function(req, res, next){
    ...
    crudService.create(crud, req.getContext().getDetails(), function(err, resCrud){
